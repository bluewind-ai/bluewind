 ...
 */
declare const mergeConfigs: <ClassGroupIds extends string, ThemeGroupIds extends string = never>(baseConfig: GenericConfig, { cacheSize, prefix, separator, experimentalParseClassName, extend, override, }: ConfigExtension<ClassGroupIds, ThemeGroupIds>) => GenericConfig;
...
export { type ClassNameValue, type ClassValidator, type Config, type DefaultClassGroupIds, type DefaultThemeGroupIds, type ExperimentalParseClassNameParam, type ExperimentalParsedClassName, createTailwindMerge, extendTailwindMerge, fromTheme, getDefaultConfig, mergeConfigs, twJoin, twMerge, validators_d as validators };
