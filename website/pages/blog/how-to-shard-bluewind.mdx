...
In my opinion, sharding by workspace is the right design.
...
Other issue. The default workspace id cannot be what I shard with, because if the user changes it I in a bad spot. I will have
user
workspace
workspace_user.workspace_id
workspace_user.user_id
workspace_user.is_default -> indicates whether this is the default workspace for this user.