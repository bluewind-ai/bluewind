...
Anytime organizations connect two vendors A and B, you end up building a piece of software C that is the sum of A, B, and the integration between A and B. When you do this multiple times with different vendors, you end up with an IT stack that is unique, very hard to monitor, maintain and improve.
