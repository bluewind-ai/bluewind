...
This page is itended to be read by my close network. It is a pitch for my pre-seed round.

# 30 seconds pitch

Bluewind is an all-in-one customer platform starting with an email drafter.

Every morning you receive 5 new email drafts in your inbox to send to potential users/customers.
...
- [in the press](https://www.google.com/search?q=merwane+hamadi&tbm=nws)
