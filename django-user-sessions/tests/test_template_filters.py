...
class PlatformTemplateFilterTest(TestCase):
    def test_windows(self):
        ...
        self.assertEqual(
            "Windows 8.1",
            platform(
                "Mozilla/5.0 (IE 11.0; Windows NT 6.3; Trident/7.0; "
        ...
        self.assertEqual(
            "Windows Mobile",
            platform(
                "Mozilla/5.0 (Windows Mobile 10; Android 8.0.0; Microsoft; Lumia "
    ...
    def test_android(self):
        ...
        self.assertEqual(
            "Android",
            platform(
                "Mozilla/5.0 (Linux; U; Android 1.5; de-de; HTC Magic "
        ...
        self.assertEqual(
            "Android",
            platform(
                "Mozilla/5.0 (Linux; Android 11; Pixel 3 XL) "
